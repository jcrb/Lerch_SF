...
path <- "../"
file <- paste0(path, "../Data/questionnaire patiente 15.12.14_saisie.csv")
...
```{r, echo=FALSE}
file2 <- "../Data/questionnaire patiente 12.12.14_Q10.csv"
...
names(b) <- c
par(mar = c(4,6,3,2))
barplot(sort(b, decreasing = TRUE), horiz = TRUE, las = TRUE, cex.names = 0.8, main = "Choix final", xlab = "Fréquence")
